...
<h1 style="height:40px;line-height:40px;background:#333;color:white;margin:0;padding:0 10px;font-size:26px;font-family: arial;">Terms and Conditions</h1>

<div style="border:4px solid #333;padding:10px;background:#f9f9f9;font-family: arial;">

  <p>{{ url }}: By placing an order through this website, you agree to the terms and conditions set for the below. Please read through these terms carefully before placing your order and print a copy for future reference. Please also read our Privacy Policy regarding personal information provided by you, which is incorporated herein by reference.</p>

  <h3>Health Disclaimer</h3>

  <p>Any statements on this site or any materials or supplements distributed or sold by {{ corpEmail }} has not been evaluated by the Food and Drug Administration (FDA). This product is not intended to diagnose, treat, cure or prevent any disease. If you are pregnant, nursing, taking medication, or have a history of heart conditions we suggest consulting with a physician before using any of our products. The results on all products are not typical and not everyone will experience these results.</p>

  <p>Phone: {{ corpPhone }} <br>

    Email: {{ corpEmail }}</p>

  <h3>Terms of Trial:</h3>

  <p>By placing your order today you'll be shipped a 30 day supply of {{ productName }} (you just pay P&amp;P). If you feel {{ productName }} not for you, cancel within 18 days (International orders (outside the Untied States) will have a 10 day extended trial for a total of 24 day trial) from the day you order to avoid the purchase fee of {{ rebillPrice }} per item and enrolment in the auto-shipment program, which sends you a fresh supply of {{ productName }} every 30 days, starting 30 days after your trial period starts, at the low price of {{ rebillPrice }} per item. By ordering you agree to the terms and conditions shown here. To cancel anytime email {{ corpEmail }}.



    Merchant has the right to bill the customer any of the below discounted prices:<br/>

    $67.49; $58.49; $49.49; $45.00; $40.50; $31.50; $19.80.</p>

  <h3>Return Policy:</h3>

  <p>In order to obtain your refund, contact customer service by phone or email and obtain an RMA (Return Merchandise Authorization) number to place on your package. Write this number on the outside of the shipping package, and send back the unopened product to our fulfillment center at the address listed below, within thirty (30) days of the date you originally ordered the product. In order for your refund to be processed the product must arrive at our fulfillment facility within thirty (30) days of the original purchase date. You pay for return shipping. Once our fulfillment center has received the package and relayed the correct information to us, you will be issued a refund. Your refund will be credited back to your bank account, and may take up to 3-5 business days to show in your statement, depending on the speed of the processing bank.</p>

  <p>Address the return package to:</p>

  {{ returnAddress }}<br>

  <h3>Shipping</h3>

  <p>The standard ground mail service is shipped via United States Postal Service First Class Mail. With our Expedited Shipping Option, we will make your shipment our priority and ship these packages out the same day for all orders placed before 1PM Pacific Standard Time and the next day for all orders placed after 1PM Pacific Standard Time (packages will arrive within 3-5 business days). Please be advised that shipments are not sent out on Saturdays, Sundays, or any Holidays. We do not guarantee arrival dates or times.</p>

  <h3>TERMS OF SERVICE</h3>

  <p>This Terms of Service ("TOS") is a legally binding agreement made by and between {{ corpName }} ("we" or "us") and you, personally and, if applicable, on behalf of the entity for whom you are using this web site (collectively, "you"). This TOS governs your use of the {{ url }} web site.</p>

  <p>Corporate Name and Address (Not return address)</p>

  <p style="white-space:pre-line;">{{ corpName }}<br>

    Corp Address: {{ corpAddress }}

  <p><strong>1. Using the Web Site.</strong></p>

  <p>(a) Eligibility. Except as expressly provided below, Services may only be used by, and Membership is limited to, individuals who can form legally binding contracts under applicable law. Without limitation, minors are prohibited from becoming Members and, except as specifically provided below, using fee-based Services. Membership is defined by engaging in a purchase agreement with PureRaspberry Ketone wherein you, the consumer purchase one of the products found on the Web Site.</p>

  <p>(b) Compliance. You must comply with all of the terms and conditions of this TOS, the policies referred to below, and all applicable laws, regulations and rules when you use the Web Site.</p>

  <p>(c) License and Restrictions. Subject to the terms and conditions of this TOS, you are hereby granted a limited, non-exclusive right to use the content and materials on the Web Site in the normal course of your use of the Web Site. You may not use any third party intellectual property without the express written permission of the applicable third party, except as permitted by law. The Website will retain ownership of its intellectual property rights and you may not obtain any rights therein by virtue of this TOS or otherwise, except as expressly set forth in this TOS. You will have no right to use, copy, display, perform, create derivative works from, distribute, have distributed, transmit or sublicense from materials or content available on the Web Site, except as expressly set forth in this TOS. You may not attempt to reverse engineer any of the technology used to provide the Services.</p>

  <p>(d) Prohibited Conduct. In your use of the Web Site and the Services, you may not: (i) infringe any patent, trademark, trade secret, copyright, right of publicity or other right of any party; (ii) defame, abuse, harass, stalk any individual, or disrupt or interfere with the security or use of the Services, the Web Site or any web sites linked to the Web Site; (iii) interfere with or damage the Web Site or Services, including, without limitation, through the use of viruses, cancel bots, Trojan horses, harmful code, flood pings, denial of service attacks, packet or IP spoofing, forged routing or electronic mail address information or similar methods or technology; (iv) attempt to use another user's account, impersonate another person or entity, misrepresent your affiliation with a person or entity, including (without limitation) the Website or create or use a false identity; (v) attempt to obtain unauthorized access to the Web Site or portions of the Web Site that are restricted from general access; (vi) engage, directly or indirectly, in transmission of "spam," chain letters, junk mail or any other type of unsolicited solicitation; (vii) collect, manually or through an automatic process, information about other users without their express consent or other information relating to the Web Site or the Services; (viii) use any meta tags or any other "hidden text" utilizing the {{ productName }} name, trademarks, or product names; (ix) advertise, offer to sell, or sell any goods or services, except as expressly permitted by the Website; (x) engage in any activity that interferes with any third party's ability to use or enjoy the Web Site or Services; or (xi) assist any third party in engaging in any activity prohibited by this TOS.</p>
  ...
  <p><strong>2. Your Content.</strong></p>
  ...
  <p>(b) Objectionable Content. We do not have the ability to control the nature of the user-generated content offered through the Web Site. You are solely responsible for your interactions with other users of the Web Site and any content that you post. We will not be liable for any damage or harm resulting from any content or your interactions with other users of the Web Site. We reserve the right, but have no obligation, to monitor interactions between you and other users of the Web Site and take any other action to restrict access to or the availability of any material that we or another user of the Web Site may consider to be obscene, lewd, lascivious, filthy, excessively violent, harassing or otherwise objectionable (including, without limitation, because it violates this TOS).</p>

  <p><strong>3. Accuracy of Information.</strong></p>

  <p>We attempt to ensure that the information on the Web Site is complete and accurate; however, this information may contain typographical errors, pricing errors, and other errors or inaccuracies. We assume no responsibility for such errors and omissions, and reserve the right to: (i) revoke any offer stated on the Web Site; (ii) correct any errors, inaccuracies or omissions



    <!--; and (iii) make changes to prices, content, promotions, product descriptions or specifications, or other information on the Web Site-->



    .</p>

  <p><strong>4. Sales Tax.</strong></p>

  <p>If you purchase any products available on the Web Site ("Products"), you will be responsible for paying any applicable sales tax indicated on the Web Site.</p>

  <p><strong>5. Fraud.</strong></p>
  ...
  <p><strong>11. DISCLAIMERS, EXCLUSIONS AND LIMITATIONS.</strong></p>

  <p>(a) DISCLAIMER OF WARRANTIES. WE PROVIDE THE WEB SITE, THE PRODUCTS, AND SERVICES ON AN "AS IS" AND "AS AVAILABLE" BASIS. WE DO NOT REPRESENT OR WARRANT THAT THE PRODUCTS, THE WEB SITE, THE SERVICES, ITS USE, ANY INFORMATION ON IT: (I) WILL BE UNINTERRUPTED OR SECURE, (II) WILL BE FREE OF DEFECTS, INACCURACIES OR ERRORS, (III) WILL MEET YOUR REQUIREMENTS, OR (IV) WILL OPERATE IN THE CONFIGURATION OR WITH OTHER HARDWARE OR SOFTWARE YOU USE. WE MAKE NO WARRANTIES OTHER THAN THOSE MADE EXPRESSLY IN THIS TOS, AND HEREBY DISCLAIM ANY AND ALL IMPLIED WARRANTIES, INCLUDING WITHOUT LIMITATION, WARRANTIES OF FITNESS FOR A PARTICULAR PURPOSE, MERCHANTABILITY AND NON-INFRINGEMENT.</p>

  <p>(b) DISCLAIMER OF FORWARD-LOOKING STATEMENTS. THIS WEB SITE MAY CONTAIN FORWARD-LOOKING STATEMENTS THAT REFLECT OUR CURRENT EXPECTATION REGARDING FUTURE EVENTS AND BUSINESS DEVELOPMENT. THE FORWARD-LOOKING STATEMENTS INVOLVE RISKS AND UNCERTAINTIES. ACTUAL DEVELOPMENTS OR RESULTS COULD DIFFER MATERIALLY FROM THOSE PROJECTED AND DEPEND ON A NUMBER OF FACTORS, SOME OF WHICH ARE OUTSIDE OUR CONTROL.</p>
  ...
  <p>(f) LIMITATION OF LIABILITY. IN NO EVENT WILL OUR AGGREGATE LIABILITY ARISING FROM, RELATING TO, OR IN CONNECTION WITH THIS TOS (INCLUDING, WITHOUT LIMITATION, CLAIMS RELATING TO THE WEB SITE, OR THE PRODUCTS) EXCEED THE GREATER OF $100 OR THE AMOUNT THAT YOU PAID FOR THE PRODUCTS.</p>

  <p><strong>12. Force Majeure.</strong></p>

  <p>You acknowledge and understand that if the Web Site is unable to provide the Products as a result of a force majeure event the Website will not be in breach of any of its obligations towards You under these Terms of Service. A force majeure event means any event beyond the control of the Website. THE WEBSITE SHALL NOT HAVE ANY LIABILITY TO YOU WHETHER IN CONTRACT, WARRANTY, TORT (INCLUDING NEGLIGENCE), OR ANY OTHER FORM OF LIABILITY FOR FAILING TO PERFORM ITS OBLIGATIONS UNDER THIS AGREEMENT TO THE EXTENT THAT SUCH FAILURE IS AS A RESULT OF A FORCE MAJEURE EVENT.</p>

  <p><strong>13. Domestic Use</strong></p>

  <p>Export Restriction. We control the Web Site from our offices within the United States of America. We make no representation that the Web Site or its content (including, without limitation, any products or services available on or through the Web Site) are appropriate or available for use in other locations. Users who access the Web Site from outside the United States of America do so on their own initiative and must bear all responsibility for compliance with local laws, if applicable. Further, the United States export control laws prohibit the export of certain technical data and software to certain territories. No content from the Web Site may be downloaded in violation of United States law.</p>

  <p><strong>14. Arbitration.</strong></p>

  <p>All disputes arising out of or relating to this TOS (including its formation, performance or alleged breach) or your use of the Web Site will be exclusively resolved under confidential binding arbitration held in {{ corpCityState }} before and in accordance with the Rules of the American Arbitration Association. The arbitrator's award will be binding and may be entered as a judgment in any court of competent jurisdiction. To the fullest extent permitted by applicable law, no arbitration under this TOS will be joined to an arbitration involving any other party subject to this TOS, whether through class arbitration proceedings or otherwise. Notwithstanding the foregoing, we will have the right to seek injunctive or other equitable relief in state or federal court located in {{ corpCityState }} to enforce this TOS or prevent an infringement of a third party's rights. In the event equitable relief is sought, each party hereby irrevocably submits to the personal jurisdiction of such court.</p>

  <p><strong>15. Waiver of Class Action Rights.</strong></p>
  ...
  <p><strong>16. Limitation of Actions.</strong></p>

  <p>You acknowledge and agree that, regardless of any statute or law to the contrary, any claim or cause of action you may have arising out of, relating to, or connected with your use of the Web Site, must be filed within one calendar year after such claim or cause of action arises, or forever be barred.</p>

  <p><strong>17. Modification of Terms of Service.</strong></p>
